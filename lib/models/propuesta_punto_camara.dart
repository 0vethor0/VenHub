class PropuestaPuntoCamara {
  ...
  factory PropuestaPuntoCamara.fromMap(Map<String, dynamic> map) {
    double lat = 0.0;
    double lon = 0.0;
    ...
    return PropuestaPuntoCamara(
      id: map['id']?.toString() ?? '',
      nombre: map['nombre'] ?? map['name'] ?? 'Propuesta sin nombre',
      latitud: lat,
      longitud: lon,
      ...
      estadoPropuesta: map['estado_propuesta'] ?? 'pendiente',
      puntoCamaraReferenciaId: map['punto_camara_referencia_id']?.toString(),
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'punto_camara_referencia_id': puntoCamaraReferenciaId,
