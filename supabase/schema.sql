-- 1. Habilitar la extensión PostGIS para coordenadas y análisis geoespacial
...
-- 4. Tabla de Puntos de Cámara (con soporte PostGIS GEOGRAPHY)
...
-- 5. Índice Espacial GIST para acelerar consultas geoespaciales por cercanía
CREATE INDEX IF NOT EXISTS idx_puntos_camara_ubicacion ON puntos_camara USING GIST (ubicacion);

-- 5. Tabla de Reportes / Observaciones (Foro)
...
-- 7. Tabla de Registro de Versiones (CD)
...
-- 10. Función RPC helper para exportar puntos como GeoJSON
...
-- 11. Trigger para manejar creación automática de perfil tras registro en Supabase Auth
